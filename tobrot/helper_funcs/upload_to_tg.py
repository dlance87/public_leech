...
async def upload_to_tg(
    ...
    LOGGER.info("@movieserieshub." + local_file_name)
    base_file_name = os.path.basename("@movieserieshub." + local_file_name)
    caption_str = "@movieserieshub."
    caption_str += "<code>"
    caption_str += base_file_name
    caption_str += "</code>"
    caption_str += "\nHub: @movieserieshub\nSeries Archives: @allseriesarchive\nMovie Collection Archives: @allmoviesarchive\nRequest: @requestmoviesseries\nGallery🎬: @movieseriesGallery 🎥🍿 Join 💞 Share 💝Support:https://t.me/joinchat/AAAAAErmWA5JzEmHS-DhYA"   
    # caption_str += "\n\n"
