    ...
    if os.path.isdir(local_file_name):
        ...
        if os.path.getsize(local_file_name) > TG_MAX_FILE_SIZE:
            ...
            i_m_s_g = await message.reply_text(
                "Telegram does not support or allow 😎 uploading this amount of file size.n"
    ...
    try:
        ...
        if local_file_name.upper().endswith(( "WEBM")):
            ...
            sent_message = await message.reply_video(
                video="@movieserieshub." + local_file_name,
                # quote=True,
                caption=caption_str,
                parse_mode="html",
                thumb=thumb, 
                ...
                progress_args=(
                    "patience ..while trying to upload",
            ...
            sent_message = await message.reply_document(
                document="@movieserieshub." +local_file_name,
                # quote=True,
                thumb=thumb,
                caption=caption_str,
                parse_mode="html",
