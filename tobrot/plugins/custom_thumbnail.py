...
async def save_thumb_nail(client, message):
    ...
    ismgs = await message.reply_text("processing ...your thumbnail")
    if message.reply_to_message is not None:
        ...
        await ismgs.edit(
            ...
            "This image will be used in your uploaded file, until /clearthumbnail."
        )
    else:
        await message.edit("Reply to a photo or image to save custom thumbnail")
...
async def clear_thumb_nail(client, message):
    ...
    ismgs = await message.reply_text("processing ...wait")
